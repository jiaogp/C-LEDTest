namespace LEDTestSysterm
{
	partial class Main
	{
		...
		private void InitializeComponent()
		{
			...
			this.gbCurStatus = new System.Windows.Forms.GroupBox();
			this.rtbStatus = new System.Windows.Forms.RichTextBox();
			this.btnPmacTest = new System.Windows.Forms.Button();
			this.groupBox1.SuspendLayout();
			((System.ComponentModel.ISupportInitialize)(this.chart1)).BeginInit();
			((System.ComponentModel.ISupportInitialize)(this.dataGridView1)).BeginInit();
			this.gbCurStatus.SuspendLayout();
			this.SuspendLayout();
			// 
			// imageList1
			// 
			...
			this.chart1.Size = new System.Drawing.Size(399, 322);
            ...
            this.Column1,
            this.Column2});
			this.dataGridView1.Location = new System.Drawing.Point(752, 27);
			...
			// button2
			// 
			this.button2.Location = new System.Drawing.Point(384, 469);
			...
			// gbCurStatus
			// 
			this.gbCurStatus.Controls.Add(this.rtbStatus);
			this.gbCurStatus.Location = new System.Drawing.Point(12, 517);
			this.gbCurStatus.Name = "gbCurStatus";
			this.gbCurStatus.Size = new System.Drawing.Size(532, 96);
			this.gbCurStatus.TabIndex = 5;
			this.gbCurStatus.TabStop = false;
			this.gbCurStatus.Text = "实时状态信息";
			// 
			// rtbStatus
			// 
			this.rtbStatus.Location = new System.Drawing.Point(6, 20);
			this.rtbStatus.Name = "rtbStatus";
			this.rtbStatus.Size = new System.Drawing.Size(526, 70);
			this.rtbStatus.TabIndex = 0;
			this.rtbStatus.Text = "";
			// 
			// btnPmacTest
			// 
			this.btnPmacTest.Location = new System.Drawing.Point(539, 458);
			this.btnPmacTest.Name = "btnPmacTest";
			this.btnPmacTest.Size = new System.Drawing.Size(94, 40);
			this.btnPmacTest.TabIndex = 6;
			this.btnPmacTest.Text = "Pmac测试";
			this.btnPmacTest.UseVisualStyleBackColor = true;
			this.btnPmacTest.Click += new System.EventHandler(this.btnPmacTest_Click);
			// 
			// Main
			// 
			...
			this.Controls.Add(this.btnPmacTest);
			this.Controls.Add(this.gbCurStatus);
			...
			this.gbCurStatus.ResumeLayout(false);
		...
		private System.Windows.Forms.GroupBox gbCurStatus;
		private System.Windows.Forms.RichTextBox rtbStatus;
		private System.Windows.Forms.Button btnPmacTest;
	}
}
